...
def _cachekey_query_api_endpoint(
    _method, _self, url, consistent=None, extra_headers=None
):
...
class QueryEntra:
    ...
    def get_access_token(self):
        """Retrieve access token. Cache response."""
    ...
    def get_user(self, user_id) -> ApiUser:
        """Get information about the specified user_id."""
    ...
    def get_group(self, group_id) -> ApiGroup:
        """Get information about the specified group_id."""
    ...
    def get_group_members(self, group_id) -> Iterator[ApiMember]:
        """Get all groups members (can be users or other groups)."""
